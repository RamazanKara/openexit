...
- Validation engine with embedded JSON Schema checks, Grafana dashboard and Prometheus alert candidate checks, YAML/JSON parsing, evidence refs, secret scan, optional promtool, and optional kubeconform.
