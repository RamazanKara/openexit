...
- Validation engine with embedded JSON Schema checks, Grafana dashboard candidate checks, YAML/JSON parsing, evidence refs, secret scan, optional promtool, and optional kubeconform.
