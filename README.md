...
The Datadog, GitHub, Okta, Auth0, Cloudflare, OpenAI, and Anthropic collectors are read-only. API tokens are read from environment variables, are not printed, and are not stored.
