...
- Validation report with embedded JSON Schema checks, Grafana dashboard candidate checks, YAML/JSON parsing, evidence ref checks, secret scan, and optional `promtool`/`kubeconform` checks.
