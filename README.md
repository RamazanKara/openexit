...
- Validation report with embedded JSON Schema checks, Grafana dashboard and Prometheus alert candidate checks, YAML/JSON parsing, evidence ref checks, secret scan, and optional `promtool`/`kubeconform` checks.
